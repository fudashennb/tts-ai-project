...
async def local_chat(request_data: dict):
    ...
    try:
        ...
        if gemini_agent is not None:
            ...
            custom_replies = {
                "你好": "车辆编号是1307，AGV的100%移动速度是95.678%，移动7864米，距#离为3.14159米. 电/池85.5%. 任务*完成.我们_了解到，95.678已经不少了，所以95  .  6是想要的结果。a d v . d a d。有时候0.52％我认为 . 1 是对的。车辆编号为1307的AGV在前天的**利用率**为 **96.52％**。",
                "天气": "抱歉，我无法查询天气信息。",
